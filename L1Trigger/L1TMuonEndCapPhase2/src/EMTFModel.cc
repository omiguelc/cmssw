...
EMTFModel::EMTFModel(const EMTFContext& context) : context_(context) {
  ...
  // clang-format off
    ...
    std::vector<zones::pattern_t> bh_zone_pd = { // Pattern N: Row0..RowM
        {{35, 55, 75}, {30, 55, 80}, {40, 55, 70}, {44, 55, 66}, {51, 55, 59}, {52, 55, 58}, {54, 55, 56}, {53, 55, 57}},
    };

    zones::quality_lut_t bh_ql = {
        0, 3, 0, 3, 0, 3, 0, 3, 4, 8, 4, 8, 5, 8, 5, 8, 6, 10, 6, 10, 6, 10, 6, 10, 12, 14, 12, 14, 12, 14, 12, 14, 0, 3, 0, 4, 1, 4, 1, 4, 5, 9, 5, 9, 5, 9, 6, 9, 7, 11, 7, 11, 7, 11, 7, 11, 13, 15, 13, 15, 13, 15, 13, 15, 7, 36, 21, 36, 21, 36, 22, 36, 37, 40, 37, 40, 37, 40, 37, 40, 38, 44, 38, 44, 38, 44, 39, 44, 48, 52, 48, 52, 48, 53, 48, 54, 23, 36, 24, 36, 25, 36, 26, 36, 37, 41, 37, 41, 37, 41, 38, 41, 39, 45, 39, 45, 39, 45, 39, 45, 49, 55, 49, 55, 49, 56, 49, 57, 1, 16, 1, 16, 1, 32, 2, 32, 17, 32, 32, 33, 18, 33, 32, 33, 19, 34, 33, 34, 33, 34, 33, 34, 34, 35, 34, 35, 34, 35, 35, 35, 2, 32, 2, 32, 2, 32, 2, 32, 32, 33, 32, 33, 32, 33, 32, 33, 20, 34, 33, 34, 33, 34, 34, 34, 35, 35, 35, 35, 35, 35, 35, 36, 7, 36, 26, 36, 27, 36, 28, 37, 38, 42, 38, 42, 38, 42, 38, 42, 39, 46, 39, 46, 39, 46, 39, 46, 50, 58, 50, 59, 50, 59, 50, 60, 29, 37, 30, 37, 31, 37, 31, 37, 38, 43, 38, 43, 38, 43, 38, 43, 39, 47, 39, 47, 39, 47, 39, 47, 51, 61, 51, 62, 51, 63, 51, 63
    };
  // clang-format on

  bh_zones_.push_back({bh_zone_hm, bh_zone_pd, bh_ql});
  ...
  // Features
  // ===========================================================================
  // feat       | ME1/1 | ME1/2 |  ME2  |  ME3  |  ME4  |  RE1  |  RE2  |  RE3  |  RE4  | GE1/1 | GE2/1 |  GE0
  // -----------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------
  // emtf_phi   |   *   |   *   |   *   |   *   |   *   |   *   |   *   |   *   |   *   |   *   |   *   |   *
  // emtf_theta |   *   |   *   |   *   |   *   |   *   |   *   |   *   |   *   |   *   |   *   |   *   |   *
  // emtf_bend  |   *   |   *   |   *   |   *   |   *   |       |       |       |       |       |       |   *
